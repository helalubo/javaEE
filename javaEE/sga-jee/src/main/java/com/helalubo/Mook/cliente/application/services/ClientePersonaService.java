...
public class ClientePersonaService {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PersonaServiceRemote personaService = (PersonaServiceRemote) jndi.lookup("java:global/sga-jee/PersonaServiceImpl!com.helalubo.Mook.persona.application.serviceRemote.PersonaServiceRemote");
